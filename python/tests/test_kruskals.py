import unittest
from py_dsa.algorithms import MST
from typing import List, Tuple

def distrubution_map(apartments: List[Tuple[int, int]]) -> list:
    """input: List of tuples representing the 2d coordinates of nodes.
